...
function startGame(characterId) {
  ...
  const propImages = {};
  // Textura de chao nao depende do mapa (mesmo asset reaproveitado em
  // qualquer lugar que use aquele tileId), entao carrega uma vez so.
  const tileImages = { 'tile_street.png': loadTileImage('tile_street.png') };
