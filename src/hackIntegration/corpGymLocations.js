...
/**
 * seatCol/seatRow: onde o personagem aparece sentado (lutador ou lider).
 * A mesa em si (a celula bloqueada, 1 acima do assento) e o ponto de
 * interacao - mesmo esquema das mesas da BLACKNET. characterId reaproveita
 * o roster jogavel (ver characterRoster.js) como placeholder visual, ate
 * ter arte propria de cada lutador.
 */
export const CORP_GYM_DESKS = {
  fighter1: { seatCol: 4, seatRow: 8, characterId: 'character2' },
  fighter2: { seatCol: 11, seatRow: 8, characterId: 'character3' },
  fighter3: { seatCol: 4, seatRow: 6, characterId: 'character4' },
  fighter4: { seatCol: 11, seatRow: 6, characterId: 'character1' },
  leader: { seatCol: 7, seatRow: 3, characterId: 'character1' },
};
